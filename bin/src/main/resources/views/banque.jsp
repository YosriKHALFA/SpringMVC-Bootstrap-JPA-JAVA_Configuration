...
<meta charset="UTF-8">
<title>banque</title>
<link href="<c:url value='/resources/static/css/style1.css' />" rel="stylesheet"></link>
<link href="<c:url value='/resources/static/css/bootstrap.css' />" rel="stylesheet"></link>
<script type="text/javascript"  src="<c:url value='/resources/static/js/Masks.js' />" ></script>	
...
<script>
	...
	if ( _GetObject('montant') != null ){
		oNumberMask.attach(_GetObject('montant'));
				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<f:form modelAttribute="banqueForm" action="saveOperation">
							...
							<div>
								<label>Montant :</label>
								<f:input path="montant" id="montant" />
							</div>
