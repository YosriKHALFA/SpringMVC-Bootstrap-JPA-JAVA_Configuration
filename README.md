# Application-for-Account-Management using : Spring 4 container (Spring MVC , Spring IOC), Bootstrap ,JPA with java configuration for persisatnce and view resolve
# **Screenshot**
